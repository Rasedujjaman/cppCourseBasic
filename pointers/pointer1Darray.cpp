...
// here we allocate the memory for the array at runtime of the program: this is called dynamic memory
// allocation. The compiler does not know in advance how much memroy will be allocated for the array
// In c++, new() operator is used to dynamically allocate memory while in C programming, there are some 
// dedicated function called malloc(), alloc() for dynamically allocate momory
